    ...
    <>
      <div className="w-full h-16">
        ...
        >
          ...
          {/* User Section */}
          <div className="w-[50%] sm:w-[35%] md:w-[25%] lg:w-2/5 xl:w-[25%] 2xl:w-[20%] flex justify-end items-center ">
            {/* User Section in Navbar */}
            {user || venue || admin ? (
              <>
                {/* User Section in Navbar */}
                <div className="w-[40%] md:w-[70%] flex items-center justify-center px-[3px] space-x-8 sm:px-8 pr-16 md:pr-16 lg:pr-24 xl:px-2 2xl:px-2">
